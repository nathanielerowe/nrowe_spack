...
class Castxml(CMakePackage):
    ...
    def cmake_args(self):
        ...
        args = [
            ...
            "-DCLANG_RESOURCE_DIR=/lus/grand/projects/neutrinoGPU/software/fermi-spack-Jul7/spack/opt/spack/linux-sles15-zen3/gcc-12.3.0/llvm-16.0.6-dx6k4rbtvyi444qsx5dizcwosdjklc63/lib/clang/16/"
        ]
        return args
